...
<body>
    ...
    <main>
        ...
        <section id="home" class="section">
            <div class="container home-content">
                ...
                <h3 class="slide-up" style="transition-delay: 200ms;">Full Stack Developer</h3>
                ...
                <div class="cta-buttons slide-up" style="transition-delay: 400ms;">
                    ...
                    <a href="javascript:void(0);" id="download-cv" class="btn secondary">Download CV</a>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                ...
                <div class="projects-grid">
                    <div class="project-card">
                        ...
                        <h3>OmniCart E-Commerce</h3>
                        <p>A full-featured e-commerce platform built with React and Node.js, featuring secure payments
                            and user authentication.</p>
                    </div>
                    <div class="project-card">
                        <i class="fa-solid fa-chart-line icon"></i>
                        <h3>DataViz Dashboard</h3>
                        <p>A real-time data visualization dashboard using D3.js and WebSockets for dynamic data updates.
                        </p>
                    </div>
                    <div class="project-card">
                        <i class="fa-solid fa-comments icon"></i>
                        <h3>Real-Time Chat App</h3>
                        <p>A performant chat application utilizing Socket.io for instantaneous, multi-user messaging.
                        </p>
                    </div>
                    <div class="project-card">
                        <i class="fa-solid fa-lock icon"></i>
                        <h3>Auth Service Microservice</h3>
                        <p>A dedicated microservice for user identity and authorization, secured with JWTs and deployed
                            via Docker.</p>
                    </div>
                    <div class="project-card">
                        <i class="fa-solid fa-microchip icon"></i>
                        <h3>IoT Sensor Gateway</h3>
                        <p>Backend API in Express.js handling data ingestion from thousands of remote IoT devices.</p>
                    </div>
                    <div class="project-card">
                        <i class="fa-solid fa-pencil icon"></i>
                        <h3>Markdown Editor SaaS</h3>
                        <p>A collaborative online markdown editor with version control and Firestore real-time syncing.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.getElementById('download-cv').addEventListener('click', () => {
            console.log("CV Download initiated. (In a real site, this would trigger a file download)");
            const messageEl = document.getElementById('form-message');
            messageEl.style.opacity = 1;
            messageEl.textContent = 'CV Download simulated. Check the console for action details.';
            setTimeout(() => messageEl.style.opacity = 0, 3000);
        });
